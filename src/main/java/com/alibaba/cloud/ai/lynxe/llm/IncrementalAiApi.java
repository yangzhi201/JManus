...
// * API</a> and <a
// href="https://platform.openai.com/docs/api-reference/embeddings">OpenAI
// * Embedding API</a>.
// *
...
// EmbeddingModel.TEXT_EMBEDDING_ADA_002.getValue();

// private static final Predicate<String> SSE_DONE_PREDICATE = "[DONE]"::equals;

// private static final String REQUEST_BODY_NULL_MESSAGE = "The request body can not be
// null.";

// private static final String STREAM_FALSE_MESSAGE = "Request must set the stream
// property to false.";

// private static final String ADDITIONAL_HEADERS_NULL_MESSAGE = "The additional HTTP
...
// private IncrementalAiStreamFunctionCallingHelper chunkMerger = new
// IncrementalAiStreamFunctionCallingHelper();
...
// */
// public IncrementalAiApi(String baseUrl, ApiKey apiKey, MultiValueMap<String, String>
// headers, String completionsPath,
// String embeddingsPath, RestClient.Builder restClientBuilder, WebClient.Builder
// webClientBuilder,
...
// * and headers.
// */
// public ResponseEntity<ChatCompletion> chatCompletionEntity(ChatCompletionRequest
// chatRequest) {
...
// */
// public Flux<ChatCompletionChunk> chatCompletionStream(ChatCompletionRequest
// chatRequest) {
...
// *
// * <pre>{@code List.of("text1", "text2", "text3") or List.of(List.of(1, 2, 3),
// List.of(3, 4, 5))} </pre>
// */
// public <T> ResponseEntity<EmbeddingList<Embedding>> embeddings(EmbeddingRequest<T>
// embeddingRequest) {
...
// Assert.isTrue(embeddingRequest.input() instanceof String || embeddingRequest.input()
// instanceof List,
// "The input must be either a String, or a List of Strings or List of List of
// integers.");
...
// Assert.isTrue(
// list.get(0) instanceof String || list.get(0) instanceof Integer || list.get(0)
// instanceof List,
// "The input must be either a String, or a List of Strings or list of list of
// integers.");
// }
...
// if (!headers.containsKey(HttpHeaders.AUTHORIZATION) && !(this.apiKey instanceof
// NoopApiKey)) {
...
// */
// @JsonInclude(Include.NON_NULL)
// public record ImageUrl(@JsonProperty("url") String url, @JsonProperty("detail") String
// detail) {
...
// return false;
// }
// return Objects.equals(this.index, other.index) && Arrays.equals(this.embedding,
// other.embedding)
...
// this.restClientBuilder = api.restClient != null ? api.restClient.mutate() :
// RestClient.builder();
// this.webClientBuilder = api.webClient != null ? api.webClient.mutate() :
// WebClient.builder();
...
// return new OpenAiApi(this.baseUrl, this.apiKey, this.headers, this.completionsPath,
// this.embeddingsPath,
